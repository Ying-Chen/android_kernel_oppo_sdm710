...
typedef enum nxpTfa9874BfEnumList {
    ...
    TFA9874_BF_TDMDCG =
            0x6123, /*!< Second channel gain in case of stereo using a single coil. (Total gain
    ...
    TFA9874_BF_LVLCLPPWM = 0x6f72,  /*!< set the amount of pwm pulse that may be skipped before
                                       clip-flag is triggered */
    TFA9874_BF_DCMCC = 0x7033,      /*!< Max coil current                                   */
    TFA9874_BF_DCCV = 0x7071,       /*!< Slope compensation current, represents LxF (inductance x
                                       frequency) value  */
    ...
    TFA9874_BF_DCTRACK = 0x7430,    /*!< Boost algorithm selection, effective only when
                                       boost_intelligent is set to 1 */
    TFA9874_BF_DCTRIP =
            0x7444, /*!< 1st Adaptive boost trip levels, effective only when DCIE is set to 1 */
    TFA9874_BF_DCHOLD = 0x7494, /*!< Hold time for DCDC booster, effective only when
                                   boost_intelligent is set to 1 */
    TFA9874_BF_DCTRIP2 =
            0x7534, /*!< 2nd Adaptive boost trip levels, effective only when DCIE is set to 1 */
    TFA9874_BF_DCTRIPT = 0x7584,     /*!< Track Adaptive boost trip levels, effective only when
                                        boost_intelligent is set to 1 */
...
#define TFA9874_BITNAMETABLE                                                                           \
    static tfaBfName_t Tfa9874BitNames[] = {                                                           \
            ...
            {0x6123,                                                                                   \
             "ctrl_attl"}, /* Second channel gain in case of stereo using a single coil. (Total        \
                              gain depending on INPLEV). (In case of mono OR stereo using 2            \
                              separate DCDC channel 1 should be disabled using TDMDCE), */             \
            ...
            {0x6405, "lpm1_cal_offset"}, /* low power mode1 detector   ctrl cal_offset from gain       \
                                            module , */                                                \
            ...
            {0x7360, "bst_use_new_zercur_detect"}, /* Enable new zero current detection for boost      \
                                                      control, */                                      \
            ...
            {0x8c90, "vs_adc_slowdel"},  /* Select delay for voltage sense ADC (internal decision      \
                                            circuitry), */                                             \
            {0x8d10, "vs_classd_tran_skip"}, /* Skip voltage sense connection during a classD          \
                                                amplifier transition, */                               \
            ...
            {0xc787, "digimuxb_sel"}, /* DigimuxB input selection control routed to INT (see           \
                                         Digimux list for details), */                                 \
            {0xc807, "digimuxc_sel"}, /* DigimuxC input selection control routed to PDMDAT (see        \
                                         Digimux list for details), */                                 \
            ...
            {0xd661, "clkdiv_muxb_sel"},  /* DCDC MUXB clock divider selection in direct clock         \
                                             control mode, */                                          \
            {0xd721, "datao_ehs"}, /* Speed/load setting for DATAO  IO cell, clk or data mode          \
                                      range (see SLIMMF IO cell datasheet), */                         \
            ...
            {0xf9d2, "spare_mtp9_15_12"}, /* MTP-control FW - See Firmware I2C API document for        \
                                             details, */                                               \

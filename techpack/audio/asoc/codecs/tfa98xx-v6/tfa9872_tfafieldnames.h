...
typedef enum nxpTfa9872BfEnumList {
    ...
    TFA9872_BF_LVLCLPPWM = 0x6f72,  /*!< set the amount of pwm pulse that may be skipped before
                                       clip-flag is triggered */
    TFA9872_BF_DCVOS = 0x7002,      /*!< Second boost voltage level                         */
    TFA9872_BF_DCMCC = 0x7033,      /*!< Max coil current                                   */
    TFA9872_BF_DCCV = 0x7071,       /*!< Slope compensation current, represents LxF (inductance x
                                       frequency) value  */
    ...
    TFA9872_BF_DCTRACK = 0x7430,    /*!< Boost algorithm selection, effective only when
                                       boost_intelligent is set to 1 */
    TFA9872_BF_DCTRIP =
            0x7444, /*!< 1st Adaptive boost trip levels, effective only when DCIE is set to 1 */
    TFA9872_BF_DCHOLD = 0x7494, /*!< Hold time for DCDC booster, effective only when
                                   boost_intelligent is set to 1 */
    TFA9872_BF_DCTRIP2 =
            0x7534, /*!< 2nd Adaptive boost trip levels, effective only when DCIE is set to 1 */
    TFA9872_BF_DCTRIPT = 0x7584,    /*!< Track Adaptive boost trip levels, effective only when
                                       boost_intelligent is set to 1 */
...
#define TFA9872_BITNAMETABLE                                                                             \
    static tfaBfName_t Tfa9872BitNames[] = {                                                             \
            ...
            {0x7502, "track_decay"}, /* DCDC Boost decay speed after a peak value, effective only        \
            ...
            {0xd661, "clkdiv_muxb_sel"},  /* DCDC MUXB clock divider selection in direct clock           \
                                             control mode, */                                            \
            {0xd701, "pdmdat_ehs"}, /* Speed/load setting for PDMDAT  IO cell, clk or data mode          \
                                       range (see SLIMMF IO cell datasheet), */                          \
            {0xd721, "datao_ehs"},  /* Speed/load setting for DATAO  IO cell, clk or data mode           \
                                       range (see SLIMMF IO cell datasheet), */                          \
            {0xd740, "bck_ehs"}, /* Speed/load setting for DATAO  IO cell, clk or data mode range        \
                                    (see SLIMMF IO cell datasheet), */                                   \
            {0xd750, "datai_ehs"},  /* Speed/load setting for DATAO  IO cell, clk or data mode           \
                                       range (see SLIMMF IO cell datasheet), */                          \
            {0xd760, "pdmclk_ehs"}, /* Speed/load setting for DATAO  IO cell, clk or data mode           \
                                       range (see SLIMMF IO cell datasheet), */                          \
            ...
            {0xf1a5, "spare_mpt1_15_10"}, /* Offset for amplifier, HW gain module - left channel         \
                                             (2's complement), */                                        \
            ...
            {0xf9c3, "spare_mtp9_15_12"}, /* MTP-control FW - See Firmware I2C API document for          \
                                             details, */                                                 \
...
#define TFA9872_IRQ_NAMETABLE                                                              \
    static tfaIrqName_t Tfa9872IrqNames[] =                                                \
            {                                                                              \
                    ...
                    {8, "8"},        {9, "9"},        {10, "STSWS"},   {11, "11"},         \
                    {12, "STAMPS"},  {13, "STAREFS"}, {14, "STADCCR"}, {15, "15"},         \
                    {16, "STBSTCU"}, {17, "STBSTHI"}, {18, "STBSTOC"}, {19, "STBSTPKCUR"}, \
                    {20, "STBSTVC"}, {21, "STBST86"}, {22, "STBST93"}, {23, "23"},         \
                    {24, "24"},      {25, "STOCPR"},  {26, "STMWSRC"}, {27, "27"},         \
                    {28, "STMWSMU"}, {29, "29"},      {30, "30"},      {31, "STCLKOOR"},   \
                    {32, "STTDMER"}, {33, "33"},      {34, "STCLPR"},  {35, "35"},         \
                    {36, "STLP0"},   {37, "STLP1"},   {38, "STLA"},    {39, "STVDDPH"},    \
                    {40, "40"},                                                            \
    };

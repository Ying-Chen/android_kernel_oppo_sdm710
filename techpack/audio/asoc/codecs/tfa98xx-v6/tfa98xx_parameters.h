...
static const int nxpTfaSamplerateHz[fs_count] = {8000,  11025, 12000, 16000, 22050,
...
typedef struct nxpTfaLsCompensationFilter {
    ...
    uint8_t lsCompOn;    // Loudspeaker compensation on/off; when 'off', the DSP code doesn't apply

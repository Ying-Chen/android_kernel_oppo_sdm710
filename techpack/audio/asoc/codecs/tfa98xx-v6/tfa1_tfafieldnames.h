...
typedef enum nxpTfa1BfEnumList {
    ...
    TFA1_BF_TROS = 0x0800,   /*!< Select external temperature also the ext_temp will be put on the
                                temp read out  */
    ...
    TFA1_BF_MEMA = 0x720f, /*!< activate memory access (24- or 32-bits data is written/read to/from
                              memory */
...
#define TFA1_NAMETABLE                                                                             \
    static tfaBfName_t Tfa1DatasheetNames[] = {                                                    \
            ...
            {0xb07, "MTPK"},   /* 5Ah, 90d To access KEY1_Protected registers (Default for         \
                                  engineering), */                                                 \
...
#define TFA1_BITNAMETABLE                                                                          \
    static tfaBfName_t Tfa1BitNames[] = {                                                          \
            ...
            {0xb07, "mtpkey2"}, /* 5Ah, 90d To access KEY1_Protected registers (Default for        \
                                   engineering), */                                                \
            ...
            {0x3040, "flag_ocpokbst"}, /* flag_ocpokbst, indication no over current in boost       \
                                          converter pmos switch, */                                \
            {0x3050,                                                                               \
             "flag_peakcur"}, /* flag_peakcur, indication current is max in dcdc converter, */     \
            {0x3060, "flag_ocpokap"}, /* flag_ocpokap, indication no over current in amplifier "a" \
                                         pmos output stage, */                                     \
            {0x3070, "flag_ocpokan"}, /* flag_ocpokan, indication no over current in amplifier "a" \
                                         nmos output stage, */                                     \
            {0x3080, "flag_ocpokbp"}, /* flag_ocpokbp, indication no over current in amplifier "b" \
                                         pmos output stage, */                                     \
            {0x3090, "flag_ocpokbn"}, /* flag_ocpokbn, indication no over current in amplifier"b"  \
                                         nmos output stage, */                                     \
            {0x30a0,                                                                               \
            ...
            {0x4940, "clipfast"}, /* clock switch for battery protection clipper, it switches back \
                                     to old frequency, */                                          \
            ...
            {0x49f0, "setse"}, /* switches between Single Ende and differential mode; 1 is single  \
                                  ended, */                                                        \
            ...
            {0x57c0,                                                                               \
             "ocptest"}, /* ctrl_ocptest, deactivates the over current protection in the power     \

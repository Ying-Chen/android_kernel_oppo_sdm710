...
typedef enum Tfa9873B0BfEnumList {
    ...
    TFA9873B0_BF_LVLCLPPWM = 0x6f72,  /*!< Set the amount of pwm pulse that may be skipped before
                                         clip-flag is triggered */
    ...
    TFA9873B0_BF_DCTRACK = 0x7430, /*!< Boost algorithm selection, effective only when
                                      boost_intelligent is set to 1 */
    TFA9873B0_BF_DCTRIP =
            0x7444, /*!< 1st Adaptive boost trip levels, effective only when DCIE is set to 1 */
    TFA9873B0_BF_DCHOLD = 0x7494, /*!< Hold time for DCDC booster, effective only when
                                     boost_intelligent is set to 1 */
    TFA9873B0_BF_DCINT = 0x74e0, /*!< Selection of data for adaptive boost algorithm, effective only
                                    when boost_intelligent is set to 1 */
    TFA9873B0_BF_DCTRIP2 =
            0x7534, /*!< 2nd Adaptive boost trip levels, effective only when DCIE is set to 1 */
    TFA9873B0_BF_DCTRIPT = 0x7584,     /*!< Track Adaptive boost trip levels, effective only when
                                          boost_intelligent is set to 1 */
    ...
    TFA9873B0_BF_MTPADDR = 0xa302, /*!< MTP address from I2C register for read/writing mtp in manual
                                      single word mode */
    ...
    TFA9873B0_BF_PLLINSI = 0xcd05,  /*!< PLL INSELI - PLL direct bandwidth control mode, only with
                                       pll_bandsel set to 1 */
    TFA9873B0_BF_PLLINSP = 0xcd64,  /*!< PLL INSELP - PLL direct bandwidth control mode only with
                                       pll_bandsel set to 1 */
    TFA9873B0_BF_PLLINSR = 0xcdb3,  /*!< PLL INSELR - PLL direct bandwidth control mode only with
                                       pll_bandsel set to 1 */
    ...
    TFA9873B0_BF_PLLMDECM = 0xcea0,  /*!< MSB of PLL MDEC in direct control mode only,
                                        use_direct_pll_ctrl set to 1 */
    TFA9873B0_BF_PLLBP = 0xceb0,     /*!< PLL bypass control during functional mode          */
    TFA9873B0_BF_PLLDI = 0xcec0,     /*!< PLL directi control in direct control mode only,
                                        use_direct_pll_ctrl set to 1 */
    TFA9873B0_BF_PLLDO = 0xced0,     /*!< PLL directo control in direct control mode only,
                                        use_direct_pll_ctrl set to 1 */
    TFA9873B0_BF_PLLCLKSTB = 0xcee0, /*!< PLL FRM clock stable control in direct control mode only,
                                        use_direct_pll_ctrl set to 1 */
    TFA9873B0_BF_PLLFRM = 0xcef0,    /*!< PLL free running mode control in functional mode   */
    TFA9873B0_BF_PLLMDECL = 0xcf0f,  /*!< Bits 15 to 0 of PLL MDEC in direct control mode,
                                        use_direct_pll_ctrl set to 1 */
    TFA9873B0_BF_PLLPDEC =
            0xd006, /*!< PLL PDEC in direct control mode only, use_direct_pll_ctrl set to 1 */
    TFA9873B0_BF_PLLDCTRL = 0xd070, /*!< Enabled PLL direct control mode, overrules the PLL LUT with
                                       I2C register values */
    TFA9873B0_BF_PLLLIMOFF = 0xd090, /*!< PLL up limiter control in PLL direct bandwidth control
                                        mode, pll_bandsel set to 1 */
...
#define TFA9873B0_NAMETABLE                                                                        \
    static tfaBfName_t Tfa9873B0DatasheetNames[] = {                                               \
            ...
            {0x6f72, "LVLCLPPWM"},  /* Set the amount of pwm pulse that may be skipped before      \
                                       clip-flag is triggered, */                                  \
            ...
            {0x7430, "DCTRACK"}, /* Boost algorithm selection, effective only when                 \
                                    boost_intelligent is set to 1, */                              \
            {0x7444, "DCTRIP"}, /* 1st Adaptive boost trip levels, effective only when DCIE is set \
                                   to 1, */                                                        \
            {0x7494, "DCHOLD"}, /* Hold time for DCDC booster, effective only when                 \
                                   boost_intelligent is set to 1, */                               \
            {0x74e0, "DCINT"},  /* Selection of data for adaptive boost algorithm, effective only  \
                                   when boost_intelligent is set to 1, */                          \
            {0x7534, "DCTRIP2"}, /* 2nd Adaptive boost trip levels, effective only when DCIE is    \
                                    set to 1, */                                                   \
            {0x7584, "DCTRIPT"}, /* Track Adaptive boost trip levels, effective only when          \
                                    boost_intelligent is set to 1, */                              \
            ...
            {0xa302, "MTPADDR"},  /* MTP address from I2C register for read/writing mtp in manual  \
                                     single word mode, */                                          \
            ...
            {0xcd05, "PLLINSI"},  /* PLL INSELI - PLL direct bandwidth control mode, only with     \
                                     pll_bandsel set to 1, */                                      \
            {0xcd64, "PLLINSP"},  /* PLL INSELP - PLL direct bandwidth control mode only with      \
                                     pll_bandsel set to 1, */                                      \
            {0xcdb3, "PLLINSR"},  /* PLL INSELR - PLL direct bandwidth control mode only with      \
                                     pll_bandsel set to 1, */                                      \
            ...
            {0xcea0, "PLLMDECM"},  /* MSB of PLL MDEC in direct control mode only,                 \
                                      use_direct_pll_ctrl set to 1, */                             \
            {0xceb0, "PLLBP"},     /* PLL bypass control during functional mode         , */       \
            {0xcec0, "PLLDI"},     /* PLL directi control in direct control mode only,             \
                                      use_direct_pll_ctrl set to 1, */                             \
            {0xced0, "PLLDO"},     /* PLL directo control in direct control mode only,             \
                                      use_direct_pll_ctrl set to 1, */                             \
            {0xcee0, "PLLCLKSTB"}, /* PLL FRM clock stable control in direct control mode only,    \
                                      use_direct_pll_ctrl set to 1, */                             \
            {0xcef0, "PLLFRM"},    /* PLL free running mode control in functional mode  , */       \
            {0xcf0f, "PLLMDECL"},  /* Bits 15 to 0 of PLL MDEC in direct control mode,             \
                                      use_direct_pll_ctrl set to 1, */                             \
            {0xd006,                                                                               \
             "PLLPDEC"}, /* PLL PDEC in direct control mode only, use_direct_pll_ctrl set to 1, */ \
            {0xd070, "PLLDCTRL"},  /* Enabled PLL direct control mode, overrules the PLL LUT with  \
                                      I2C register values, */                                      \
            {0xd090, "PLLLIMOFF"}, /* PLL up limiter control in PLL direct bandwidth control mode, \
                                      pll_bandsel set to 1, */                                     \
...
#define TFA9873B0_BITNAMETABLE                                                                         \
    static tfaBfName_t Tfa9873B0BitNames[] = {                                                         \
            ...
            {0xe0, "enbl_pll_synchronisation"}, /* Manager control for enabling synchronisation        \
                                                   with PLL FS, */                                     \
            ...
            {0x490, "enbl_clkref_sync"}, /* Enable PLL reference clock synchronisation for clock       \
                                            divider, */                                                \
            ...
            {0x510, "force_spkr_clk"},  /* Force active the speaker sub-system clock when in idle      \
                                           power, */                                                   \
            ...
            {0x26c3, "tdm_source0_slot"}, /* Slot Position of current sense vbat temperature and       \
                                             vddp feedback, */                                         \
            {0x2703, "tdm_source1_slot"}, /* Slot Position of Voltage sense vbat temperature and       \
                                             vddp feedback, */                                         \
            {0x4000,                                                                                   \
            ...
            {0x5450, "icomp_engage_overrule"}, /* To overrule the functional icomp_engage signal       \
                                                  during validation, */                                \
            {0x5463, "ctrl_dem"}, /* Enable DEM icomp and DEM one bit DAC              , */            \
            {0x54a1, "ref_amp_irefdist_set_ctrl"}, /* Scaling of reference current for amplifier       \
                                                      OCP    , */                                      \
            ...
            {0x5652,                                                                                   \
             "ref_irefdist_test_enbl"}, /* Enable of test-function of distribution of reference        \
                                           current, used for OCP. When enabled, the current will       \
                                           to to anamux iso powerstages. Using e.g. 011 it will        \
                                           add the current of powerstage P and N., */                  \
            {0x570a, "enbl_amp"}, /* Switch on the class-D power sections, each part of the analog     \
                                     sections can be switched on/off individually, */                  \
            ...
            {0x6005, "idle_power_cal_offset"}, /* Idle power mode detector ctrl cal_offset from        \
                                                  gain module , */                                     \
            {0x6065,                                                                                   \
            ...
            {0x6165, "idle_power_hold_time"},    /* Idle power mode detector ctrl hold time before     \
                                                    low audio is reckoned to be low audio, */          \
            ...
            {0x6365, "hold_time"},     /* Low noise gain switch ctrl hold time before low audio is     \
                                          reckoned to be low audio, */                                 \
            {0x6405,                                                                                   \
            ...
            {0x6565, "lpm1_hold_time"}, /* Low power mode1 detector ctrl hold time before low          \
                                           audio is reckoned to be low audio, */                       \
            {0x65c0, "disable_low_power_mode"}, /* Low power mode1 detector control , */                                                                                                  \
            {0x6611, "dcdc_ctrl_maxzercnt"}, /* DCDC Number of zero current flags to count before      \
                                                going to PFM mode, */                                  \
            {0x6656,                                                                                   \
             "dcdc_vbat_delta_detect"}, /* Threshold before booster is reacting on a delta Vbat        \
                                           (in PFM mode) by temporarily switching to PWM mode, */      \
            {0x66c0,                                                                                   \
            ...
            {0x6c02, "ns_hp2ln_criterion"}, /* 0..7 zeroes at ns as threshold to swap from             \
                                               high_power to low_noise, */                             \
            {0x6c32, "ns_ln2hp_criterion"}, /* 0..7 zeroes at ns as threshold to swap from             \
                                               low_noise to high_power, */                             \
            ...
            {0x6f02, "cursense_comp_delay"}, /* Delay to allign compensation signal with current       \
                                                sense signal, */                                       \
            {0x6f40,                                                                                   \
             "cursense_comp_sign"}, /* Polarity of compensation for current sense        , */          \
            {0x6f50,                                                                                   \
             "enbl_cursense_comp"},    /* Enable current sense compensation                 , */       \
            {0x6f72, "pwms_clip_lvl"}, /* Set the amount of pwm pulse that may be skipped before       \
                                          clip-flag is triggered, */                                   \
            {0x7003, "boost_cur"},     /* Max coil current                                  , */       \
            {0x7041, "bst_slpcmplvl"}, /* Slope compensation current, represents LxF (inductance x     \
                                          frequency) , */                                              \
            {0x7060, "boost_intel"},   /* Adaptive boost mode                               , */       \
            {0x7070, "boost_speed"},   /* Soft ramp up/down                                 , */       \
            {0x7085, "overshoot_correction_lvl"}, /* Threshold level to activate active overshoot      \
                                                     control, */                                       \
            ...
            {0x7350, "disable_artf654484_fix"},    /* Disables the fix for artf654484 (loss of         \
                                                      efficiency when Vbst is close to Vbat), */       \
            {0x7360, "disable_artf676996_fix"},    /* Disables the fix for artf676996 (OCP booster     \
                                                      triggered when Vtrgt is just above Vbat), */     \
            {0x7371, "ref_bst_irefdist_set_ctrl"}, /* Scaling of reference current for booster OCP     \
                                                      , */                                             \
            {0x7420, "disable_dynamic_freq"}, /* Disables the dynamic frequency switching due to       \
                                                 flag_voutcomp86/93, */                                \
            {0x7430, "boost_track"},          /* Boost algorithm selection, effective only when        \
                                                 boost_intelligent is set to 1, */                     \
            {0x7444, "boost_trip_lvl_1st"}, /* 1st Adaptive boost trip levels, effective only when     \
                                               DCIE is set to 1, */                                    \
            {0x7494, "boost_hold_time"},    /* Hold time for DCDC booster, effective only when         \
                                               boost_intelligent is set to 1, */                       \
            {0x74e0,                                                                                   \
             "sel_dcdc_envelope_8fs"}, /* Selection of data for adaptive boost algorithm,              \
                                          effective only when boost_intelligent is set to 1, */        \
            {0x74f0,                                                                                   \
             "ignore_flag_voutcomp86"},     /* Determines the maximum PWM frequency be the most        \
                                               efficient in relation to the Booster inductor value, */ \
            {0x7534, "boost_trip_lvl_2nd"}, /* 2nd Adaptive boost trip levels, effective only when     \
                                               DCIE is set to 1, */                                    \
            {0x7584, "boost_trip_lvl_track"}, /* Track Adaptive boost trip levels, effective only      \
                                                 when boost_intelligent is set to 1, */                \
            ...
            {0x8305, "cs_ktemp"},  /* Current sense temperature compensation trimming (1 -             \
                                      VALUE*TEMP)*signal, */                                           \
            ...
            {0x8490, "cs_adc_slowdel"}, /* Select delay for current sense ADC (internal decision       \
                                           circuitry), */                                              \
            {0x8510, "cs_classd_tran_skip"}, /* Skip current sense connection during a classD          \
            ...
            {0x8560, "cs_ldo_pulldown"}, /* Pull down current sense LDO, only valid if                 \
                                            left_enbl_cs_ldo is high, */                               \
            {0x8574,                                                                                   \
            ...
            {0x8790, "enbl_dc_filter"}, /* Control for enabling the DC blocking filter for voltage     \
                                           and current sense, */                                       \
            ...
            {0x8c90, "vs_adc_slowdel"},  /* Select delay for voltage sense ADC (internal decision      \
                                            circuitry), */                                             \
            ...
            {0x8d60, "vs_ldo_pulldown"}, /* Pull down voltage sense LDO, only valid if                 \
                                            left_enbl_cs_ldo is high, */                               \
            {0x8d74,                                                                                   \
             "vs_ldo_voset"}, /* Voltage sense LDO voltage level setting (two's complement), */        \
            {0x8f00, "enbl_vs_adc"},  /* Enable voltage sense ADC (Direct Control only only others     \
                                         done by manager), */                                          \
            ...
            {0x8f50, "enbl_vs_ldo"},  /* Enable voltage sense LDO (Direct Control only only others     \
                                         done by manager), */                                          \
            {0x8f80, "enbl_vs_vbatldo"}, /* Enable of voltage sense LDO (Direct Control only           \
                                            others done by manager), */                                \
            {0xa007, "mtpkey1"},      /* 5Ah, 90d To access KEY1_protected registers (default for      \
                                         engineering), */                                              \
            {0xa107, "mtpkey2"},      /* MTP KEY2 register                                 , */        \
            {0xa200, "key01_locked"}, /* Indicates KEY1 is locked                          , */        \
            {0xa210, "key02_locked"}, /* Indicates KEY2 is locked                          , */        \
            {0xa302, "mtp_man_address_in"}, /* MTP address from I2C register for read/writing mtp      \
                                               in manual single word mode, */                          \
            {0xa330,                                                                                   \
            ...
            {0xa350, "auto_copy_mtp_to_iic"}, /* Start copying all the data from mtp to I2C mtp        \
                                                 registers, */                                         \
            {0xa360,                                                                                   \
            ...
            {0xa420, "faim_sel_oddrows"},  /* All odd rows of the faim are selected, all rows in       \
                                              combination with sel_evenrows, */                        \
            {0xa430, "faim_program_only"}, /* Skip the erase access at wr_faim command                 \
                                              (write-program-marginread), */                           \
            {0xa440, "faim_erase_only"},   /* Skip the program access at wr_faim command               \
                                              (write-erase-marginread), */                             \
            ...
            {0xb200, "bypass_ovpglitchfilter"}, /* Bypass glitch filter on over voltage protection     \
                                                   signal from analog, */                              \
            {0xb210, "enbl_ovp_alarm_state"},   /* Allow manager to go into alarm state when OVP       \
                                                   (only when ctrl_vpalarm is 0), */                   \
            {0xb220, "amp_in_tristate_when_ovp"}, /* Brings amplifier in tristate when OVP (only       \
                                                     when ctrl_enbl_ovp_alarm_state is 0) , */         \
            {0xc000,                                                                                   \
            ...
            {0xc038, "enbl_ref"}, /* Switch on the analog references, each part of the references      \
                                     can be switched on/off individually, */                           \
            {0xc0c0, "use_direct_vs_ctrls"}, /* Voltage sense direct control to overrule several       \
            ...
            {0xc376, "pulselength"},   /* Pulse length setting test input for amplifier (PWM clock     \
                                          2048/4096 Fs), */                                            \
            {0xc3e0, "tdm_enable_loopback"}, /* TDM loopback test , */                                                                                                  \
            {0xc400, "bst_bypasslatch"}, /* Bypass latch in boost converter                   , */     \
            {0xc411, "bst_source"},  /* Sets the source of the pwmbst output to boost converter        \
                                        input for testing, */                                          \
            ...
            {0xc4d0, "test_bst_ocp"},   /* Boost OCP. For old OCP (ctrl_reversebst is 0), For new      \
                                           OCP (ctrl_reversebst is 1), */                              \
            {0xc4e0, "test_bst_sense"}, /* Test option for the sense NMOS in booster for current       \
                                           mode control., */                                           \
            {0xc500, "test_cvi"}, /* Analog BIST, switch choose which transistor will be used as       \
                                     current source (also cross coupled sources possible), */          \
            ...
            {0xc707, "digimuxa_sel"}, /* DigimuxA input selection control routed to DATAO (see         \
                                         Digimux list for details), */                                 \
            {0xc787, "digimuxb_sel"}, /* DigimuxB input selection control routed to INT (see           \
                                         Digimux list for details), */                                 \
            {0xc807, "digimuxc_sel"}, /* DigimuxC input selection control routed to ADS1 (see          \
                                         Digimux list for details), */                                 \
            {0xc981, "int_ehs"}, /* Speed/load setting for INT IO cell, clk or data mode range         \
                                    (see SLIMMF IO cell datasheet), */                                 \
            ...
            {0xcd05, "pll_inseli"},   /* PLL INSELI - PLL direct bandwidth control mode, only with     \
                                         pll_bandsel set to 1, */                                      \
            {0xcd64, "pll_inselp"},   /* PLL INSELP - PLL direct bandwidth control mode only with      \
                                         pll_bandsel set to 1, */                                      \
            {0xcdb3, "pll_inselr"},   /* PLL INSELR - PLL direct bandwidth control mode only with      \
                                         pll_bandsel set to 1, */                                      \
            {0xcdf0, "pll_bandsel"},  /* PLL bandwidth selection control, USE WITH CAUTION , */        \
            {0xce09, "pll_ndec"}, /* PLL NDEC in direct control mode only, use_direct_pll_ctrl set     \
                                     to 1, */                                                          \
            {0xcea0, "pll_mdec_msb"}, /* MSB of PLL MDEC in direct control mode only,                  \
                                         use_direct_pll_ctrl set to 1, */                              \
            {0xceb0, "pll_bypass"},   /* PLL bypass control during functional mode         , */        \
            {0xcec0, "pll_directi"},  /* PLL directi control in direct control mode only,              \
                                         use_direct_pll_ctrl set to 1, */                              \
            {0xced0, "pll_directo"},  /* PLL directo control in direct control mode only,              \
                                         use_direct_pll_ctrl set to 1, */                              \
            {0xcee0, "pll_frm_clockstable"}, /* PLL FRM clock stable control in direct control         \
                                                mode only, use_direct_pll_ctrl set to 1, */            \
            {0xcef0, "pll_frm"},      /* PLL free running mode control in functional mode  , */        \
            {0xcf0f, "pll_mdec_lsb"}, /* Bits 15 to 0 of PLL MDEC in direct control mode,              \
                                         use_direct_pll_ctrl set to 1, */                              \
            {0xd006, "pll_pdec"}, /* PLL PDEC in direct control mode only, use_direct_pll_ctrl set     \
                                     to 1, */                                                          \
            {0xd070, "use_direct_pll_ctrl"}, /* Enabled PLL direct control mode, overrules the PLL     \
                                                LUT with I2C register values, */                       \
            {0xd090, "pll_limup_off"}, /* PLL up limiter control in PLL direct bandwidth control       \
                                          mode, pll_bandsel set to 1, */                               \
            ...
            {0xd721, "datao_ehs"}, /* Speed/load setting for DATAO IO cell, clk or data mode range     \
                                      (see SLIMMF IO cell datasheet), */                               \
            {0xd740, "bck_ehs"},   /* High-speed and standard/fast mode selection for BCK IO cell      \
                                      (see IIC3V3 IO cell datasheet), */                               \
            {0xd750, "datai_ehs"}, /* High-speed and standard/fast mode selection for DATAI IO         \
                                      cell (see IIC3V3 IO cell datasheet), */                          \
            {0xd800, "source_in_testmode"},   /* TDM source in test mode (return only current and      \
                                                 voltage sense), */                                    \
            ...
            {0xda15, "fro_auto_trim_val"},      /* Calibration value from auto calibration, to be      \
                                                   written into MTP - Read Only, */                    \
            {0xda80, "iref_calibration_done"},  /* IREF Calibration done - Read Only  , */                                                                                                 \
            {0xda94, "iref_auto_trim_val"},     /* Calibration value from auto calibration, to be      \
                                                   written into MTP - Read Only, */                    \
            ...
            {0xf078, "calibr_speaker_info"}, /* Reserved space for allowing customer to store          \
                                                speaker information, */                                \
            {0xf105,                                                                                   \
            ...
            {0xf307, "calibr_gain_vs1"}, /* Voltage sense gain when external voltage sensing input     \
                                            is selected, */                                            \
            {0xf387, "calibr_gain_vs2"}, /* Voltage sense gain when internal voltage sensing input     \
                                            is selected, */                                            \
            {0xf407,                                                                                   \
...
#define TFA9873_IRQ_NAMETABLE                                                                \
    static tfaIrqName_t Tfa9873IrqNames[] = {                                                \
            {0, "STVDDS"},     {1, "STBSTOC"}, {2, "STOTDS"},  {3, "STOCPR"}, {4, "STUVDS"}, \
            {5, "STMANALARM"}, {6, "STTDMER"}, {7, "STNOCLK"}, {8, "8"},                     \
    };

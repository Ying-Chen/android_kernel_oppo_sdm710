...
int tfa_ext_register(dsp_write_reg_t tfa_write_reg_v6, dsp_send_message_t tfa_send_message,
                     dsp_read_message_t tfa_read_message, tfa_event_handler_t* tfa_event_handler);

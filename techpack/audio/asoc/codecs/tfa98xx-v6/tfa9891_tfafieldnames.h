...
#define TFA9891_NAMETABLE                                                                          \
    static tfaBfName_t Tfa9891DatasheetNames[] = {                                                 \
            ...
            {0x450, "CHS3"}, /* Channel Selection data 2 input (coolflux input, the DCDC converter \
                                gets the other signal), */                                         \
            ...
            {0x800, "TROS"},   /* select external temperature also the ext_temp will be put on the \
                                  temp read out , */                                               \
            ...
            {0x2250, "SAAMPGACTRL"}, /* 0 = active input common mode voltage source at the         \
                                        attenuator/PGA level, */                                   \
            ...
            {0x62b0, "CIMTP"},  /* start copying all the data from i2cregs_mtp to mtp [Key 2       \
                                   protected], */                                                  \
            ...
            {0x720f, "MEMA"},   /* activate memory access (24- or 32-bits data is written/read     \
                                   to/from memory, */                                              \
...
#define TFA9891_BITNAMETABLE                                                                       \
    static tfaBfName_t Tfa9891BitNames[] = {                                                       \
            ...
            {0x450, "lr_sw_i2si2"},  /* Channel Selection data 2 input (coolflux input, the DCDC   \
                                        converter gets the other signal), */                       \
            ...
            {0x660, "sel_other_vamp"}, /* Input selection for the second channel of the DCDC       \
                                          inteligent mode detector, */                             \
            ...
            {0x781, "ctrl_slopebst_3_2"}, /* Setting for the part of the power transistor voltage  \
                                             to be used in peak current mode control, */           \
            {0x7a0, "boost_intel"}, /* Adaptive boost mode                               , */      \
            {0x7b0, "boost_speed"}, /* Soft RampUp/Down mode for DCDC controller         , */      \
            {0x7c1, "ctrl_delay_comp_dcdc"}, /* delay compensation in current patg compared to     \
                                                delay in the audio path (relative) , */            \
            {0x7e0, "boost_input"},      /* Selection intelligent boost detector input        , */ \
            {0x7f0, "ctrl_supplysense"}, /* ADC10 input selection                             , */ \
            {0x800, "ext_temp_sel"}, /* select external temperature also the ext_temp will be put  \
                                        on the temp read out , */                                  \
            ...
            {0x8e0, "ctrl_cs_samplevalid"}, /* sample valid moment for CS in single sample moment  \
                                               mode, */                                            \
            ...
            {0xf70, "flag_cf_speakererror_mask"}, /* mask flag_cf_speakererror for interupt        \
                                                     generation , */                               \
            {0xf80, "flag_watchdog_reset_mask"},  /* mask flag_watchdog_reset for interupt         \
                                                     generation  , */                              \
            {0xf90,                                                                                \
            ...
            {0x2250, "ctrl_saam_pga_src"}, /* 0 = active input common mode voltage source at the   \
                                              attenuator/PGA level, */                             \
            ...
            {0x3050, "flag_voutcomp93"}, /* flag_voutcomp93, indication Vset is larger than 1.07*  \
                                            Vbat , */                                              \
            {0x3060, "flag_voutcomp86"}, /* flag_voutcomp86, indication Vset is larger than 1.14*  \
                                            Vbat , */                                              \
            {0x3070, "flag_hiz"},        /* flag_hiz, indication Vbst is larger than  Vbat    , */ \
            {0x3080, "flag_hi_peak"},    /* flag_hi_peak, indication hi_peak                  , */ \
            {0x3090, "flag_ocpokbst"},   /* flag_ocpokbst, indication no over current in boost     \
                                            converter pmos switch, */                              \
            {0x30a0,                                                                               \
             "flag_peakcur"}, /* flag_peakcur, indication current is max in dcdc converter, */     \
            {0x30b0, "flag_ocpokap"}, /* flag_ocpokap, indication no over current in amplifier "a" \
                                         pmos output stage, */                                     \
            {0x30c0, "flag_ocpokan"}, /* flag_ocpokan, indication no over current in amplifier "a" \
                                         nmos output stage, */                                     \
            {0x30d0, "flag_ocpokbp"}, /* flag_ocpokbp, indication no over current in amplifier "b" \
                                         pmos output stage, */                                     \
            {0x30e0, "flag_ocpokbn"}, /* flag_ocpokbn, indication no over current in amplifier"b"  \
                                         nmos output stage, */                                     \
            ...
            {0x32b0, "mtp_ecc_err2"},          /* two or more bit errors detected in MTP, can not  \
                                                  reconstruct value, */                            \
            ...
            {0x4309, "ctrl_drivebst"}, /* Drive bits to select the powertransistor sections boost  \
                                          converter, */                                            \
            ...
            {0x4400, "ctrl_reversebst"}, /* OverCurrent Protection selection of power stage boost  \
                                            converter, */                                          \
            {0x4410, "ctrl_sensetest"},  /* Test option for the sense NMOS in booster for current  \
                                            mode control., */                                      \
            ...
            {0x4840, "ctrl_coincidencebst"}, /* Switch protection on to prevent simultaniously     \
                                                switching power stages bst and amp, */             \
            ...
            {0x4910, "ctrl_bypassclip2"}, /* Bypass clip control (function depending on digimux    \
                                             clip_x), */                                           \
            {0x4920,                                                                               \
             "ctrl_clkgateCFoff"},     /* to disable clock gating in the coolflux           , */   \
            {0x4930, "ctrl_testabst"}, /* testabst                                          , */   \
            {0x4940, "ctrl_clipfast"}, /* clock switch for battery protection clipper, it switches \
            ...
            {0x4bd0, "ctrl_adc13_resonator_enable"}, /* Micadc Give extra SNR with less stability. \
                                                        Debug use only, */                         \
            ...
            {0x5007, "gain"}, /* gain setting of the gain multiplier gain need to increase with    \
                                 factor 1.41 (3dB), */                                             \
            {0x5081, "ctrl_sourceb"},   /* Set OUTB to                                       , */  \
            {0x50a1, "ctrl_sourcea"},   /* Set OUTA to                                       , */  \
            {0x50c1, "ctrl_sourcebst"}, /* Sets the source of the pwmbst output to boost converter \
                                           input for testing, */                                   \
            {0x50e1, "ctrl_test_mono"}, /* ABIST mode to add both amplifier halfs as stereo or one \
                                           amplifier half as mono, */                              \
            ...
            {0x51f0, "ctrl_bypass_ctrlloop"}, /* bypass_ctrlloop bypasses the control loop of the  \
                                                 amplifier, */                                     \
            {0x5200,                                                                               \
            ...
            {0x5343, "ctrl_digimux_out_test2"}, /* Digimux TEST2 out. output flag_clipa_low        \
                                                   depending on cntr_bypassclip setting, */        \
            {0x5383, "ctrl_digimux_out_data1"}, /* Digimux DATA1 out (output flag_clipb_high       \
                                                   depending on cntr_bypassclip setting), */       \
            {0x53c3, "ctrl_digimux_out_data3"}, /* Digimux DATA3 out  (output flag_clipx_x         \
                                                   depending on cntr_bypassclip setting), */       \
            ...
            {0x5600, "use_direct_ctrls"}, /* use_direct_ctrls, to overrule several functions       \
                                             direct for testing, */                                \
            ...
            {0x56c0, "use_direct_clk_ctrl"}, /* use_direct_clk_ctrl, to overrule several functions \
                                                direct for testing, */                             \
            {0x56d0, "use_direct_pll_ctrl"}, /* use_direct_pll_ctrl, to overrule several functions \
                                                direct for test, */                                \
            {0x56e0, "use_direct_ctrls_2"},  /* use_direct_sourseamp_ctrls, to overrule several    \
                                                functions direct for testing, */                   \
            ...
            {0x57c0, "ctrl_ocptest"}, /* ctrl_ocptest, deactivates the over current protection in  \
                                         the power stages of the amplifier. The ocp flag signals   \
                                         stay active., */                                          \
            ...
            {0x5b02, "tsig_freq_msb"}, /* select internal sinus test generator, frequency control  \
                                          msb bits, */                                             \
            {0x5b30, "inject_tsig"}, /* inject_tsig, control bit to switch to internal sinus test  \
                                        generator, */                                              \
            ...
            {0x6290, "man_copy_iic_to_mtp"}, /* start copying single word from i2cregs_mtp to mtp  \
                                                [Key 1 protected], */                              \
            {0x62a0,                                                                               \
             "auto_copy_mtp_to_iic"}, /* start copying all the data from mtp to i2cregs_mtp, */    \
            {0x62b0, "auto_copy_iic_to_mtp"}, /* start copying all the data from i2cregs_mtp to    \
                                                 mtp [Key 2 protected], */                         \
            {0x62d2, "mtp_speed_mode"}, /* Speed mode                                        , */  \
            {0x6340,                                                                               \
             "mtp_dircet_enable"},     /* mtp_direct_enable (key1 protected)                , */   \
            {0x6350, "mtp_direct_wr"}, /* mtp_direct_wr (key1 protected) direct value for mtp pin  \
                                          wr. To be enabled via iic2mtp_mtp_direct_enable, */      \
            {0x6360, "mtp_direct_rd"}, /* mtp_direct_rd  (key1 protected) direct value for mtp pin \
                                          rd. To be enabled via iic2mtp_mtp_direct_enable, */      \
            {0x6370,                                                                               \
             "mtp_direct_rst"}, /* mtp_direct_rst  (key1 protected) direct value for mtp pin rst.  \
                                   To be enabled via iic2mtp_mtp_direct_enable, */                 \
            {0x6380,                                                                               \
             "mtp_direct_ers"}, /* mtp_direct_ers  (key1 protected) direct value for mtp pin ers.  \
                                   To be enabled via iic2mtp_mtp_direct_enable, */                 \
            {0x6390,                                                                               \
             "mtp_direct_prg"}, /* mtp_direct_prg  (key1 protected) direct value for mtp pin prg.  \
                                   To be enabled via iic2mtp_mtp_direct_enable, */                 \
            {0x63a0,                                                                               \
             "mtp_direct_epp"}, /* mtp_direct_epp  (key1 protected) direct value for mtp pin epp.  \
                                   To be enabled via iic2mtp_mtp_direct_enable, */                 \
            ...
            {0x720f, "cf_mema"}, /* activate memory access (24- or 32-bits data is written/read    \
                                    to/from memory, */                                             \
            ...
            {0x8105, "calibr_vout_offset"}, /* calibr_vout_offset (DCDCoffset) 2's compliment      \
                                               (key1 protected), */                                \
            {0x8163, "calibr_delta_gain"},  /* delta gain for vamp (alpha) 2's compliment (key1    \
                                               protected), */                                      \
            {0x81a5, "calibr_offs_amp"},    /* offset for vamp (Ampoffset) 2's compliment (key1    \
                                               protected), */                                      \
            {0x8207, "calibr_gain_cs"}, /* gain current sense (Imeasalpha) 2's compliment (key1    \
                                           protected), */                                          \
            {0x8284,                                                                               \

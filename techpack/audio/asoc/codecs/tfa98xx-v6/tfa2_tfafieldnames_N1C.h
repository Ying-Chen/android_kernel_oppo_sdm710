...
#define TFA2_BITNAMETABLE                                                                          \
    static tfaBfName_t Tfa2BitNames[] = {                                                          \
            ...
            {0x32a0, "sel_cf_haptic_data"}, /* Select the source for haptic data output (not for   \
                                               customer), */                                       \
            ...
            {0x5210, "ctrl_rcv_fb_100k"}, /* Selection of feedback resistor for receiver mode (not \
                                             for customer), */                                     \
            ...
            {0x5581,                                                                               \
             "dpsa_drive"}, /* Control of the number of power stage sections, total of 4 sections. \
                               Each section is 1/4 of the total power stages., */                  \
            {0x560a,                                                                               \
             "enbl_amp_left"}, /* Switch on the class-D power sections, each part of the analog    \
                                  sections can be switched on/off individually - Left channel, */  \
            {0x56b0, "enbl_engage_left"}, /* Enables/engage power stage and control loop - left    \
                                             channel, */                                           \
            {0x570a, "enbl_amp_right"}, /* Switch on the class-D power sections, each part of the  \
                                           analog sections can be switched on/off individually -   \
                                           Right channel, */                                       \
            {0x57b0, "enbl_engage_right"}, /* Enables/engage power stage and control loop - right  \
                                              channel, */                                          \
            ...
            {0x58b0, "enbl_pwm_phase_shift_left"},  /* Control for pwm phase shift, inverted       \
                                                       function - left channel, */                 \
            ...
            {0x8110, "invertpwm_left"},  /* Current sense common mode feedback pwm invert control  \
                                            for left channel, */                                   \
            {0x8122, "cmfb_gain_left"},  /* Current sense common mode feedback control gain for    \
                                            left channel, */                                       \
            {0x8154, "cmfb_offset_left"}, /* Current sense common mode feedback control offset for \
                                             left channel, */                                      \
            {0x8200, "enbl_cmfb_right"},  /* Current sense common mode feedback control for right  \
                                             channel, */                                           \
            {0x8210, "invertpwm_right"},  /* Current sense common mode feedback pwm invert control \
                                             for right channel, */                                 \
            {0x8222, "cmfb_gain_right"},  /* Current sense common mode feedback control gain for   \
                                             right channel, */                                     \
            {0x8254, "cmfb_offset_right"}, /* Current sense common mode feedback control offset    \
                                              for right channel, */                                \
            ...
            {0x8660, "enbl_cs_nofloating_n_left"}, /* Connect current sense negative to gnda at    \
                                                      transitions of booster or classd amplifiers. \
                                                      Otherwise floating (0), */                   \
            {0x8670, "enbl_cs_nofloating_p_left"}, /* Connect current sense positive to gnda at    \
                                                      transitions of booster or classd amplifiers. \
                                                      Otherwise floating (0), */                   \
            ...
            {0x8760, "enbl_cs_nofloating_n_right"}, /* Connect current sense negative to gnda at   \
                                                       transitions of booster or classd            \
                                                       amplifiers. Otherwise floating (0), */      \
            {0x8770, "enbl_cs_nofloating_p_right"}, /* Connect current sense positive to gnda at   \
                                                       transitions of booster or classd            \
                                                       amplifiers. Otherwise floating (0), */      \
            ...
            {0xc670, "enbl_powerswitch"}, /* Vddd core power switch control - overrules the        \
                                             manager control, */                                   \
            {0xc707, "digimuxa_sel"},     /* DigimuxA input selection control routed to GPIO1 (see \
                                             Digimux list for details), */                         \
            {0xc787, "digimuxb_sel"},     /* DigimuxB input selection control routed to GPIO2 (see \
                                             Digimux list for details), */                         \
            {0xc807, "digimuxc_sel"},     /* DigimuxC input selection control routed to GPIO3 (see \
                                             Digimux list for details), */                         \
            {0xc887, "digimuxd_sel"},     /* DigimuxD input selection control routed to GPIO4 (see \
                                             Digimux list for details), */                         \
            ...
            {0xc921, "dio2_ehs"},   /* Speed/load setting for DIO2 IO cell, clk or data mode range \
                                       (see SLIMMF IO cell datasheet), */                          \
            {0xc941, "gainio_ehs"}, /* Speed/load setting for GAINIO cell, clk or data mode range  \
                                       (see SLIMMF IO cell datasheet), */                          \
            {0xc961, "pdmo_ehs"},   /* Speed/load setting for PDMO IO cell, clk or data mode range \
                                       (see SLIMMF IO cell datasheet), */                          \
            {0xc981, "int_ehs"},    /* Speed/load setting for INT IO cell, clk or data mode range  \
                                       (see SLIMMF IO cell datasheet), */                          \
            {0xc9a1, "tdo_ehs"},    /* Speed/load setting for TDO IO cell, clk or data mode range  \
                                       (see SLIMMF IO cell datasheet), */                          \
            ...
            {0xf1a5, "calibr_offset_left"}, /* Offset for amplifier, HW gain module - left channel \
                                               (2's complement), */                                \
            {0xf203,                                                                               \
             "calibr_gain_right"}, /* HW gain module - right channel (2's complement)   , */       \
            {0xf245, "calibr_offset_right"},  /* Offset for amplifier, HW gain module - right      \
                                                 channel (2's complement), */                      \
            {0xf2a3, "calibr_rcvldop_trim"},  /* Trimming of LDO (2.7V)  , */                                                                                             \
            {0xf307, "calibr_gain_cs_left"},  /* Current sense gain - left channel (signed two's   \
                                                 complement format), */                            \
            {0xf387, "calibr_gain_cs_right"}, /* Current sense gain - right channel (signed two's  \
                                                 complement format), */                            \
            ...
            {0xff05, "calibr_osc_delta_ndiv"}, /* Calibration data for OSC1M, signed number        \
                                                  representation, */                               \
            {0xffff, "Unknown bitfield enum"}  /* not found */                                     \
    };

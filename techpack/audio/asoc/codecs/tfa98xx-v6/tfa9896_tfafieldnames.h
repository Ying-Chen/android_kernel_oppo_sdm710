...
#define TFA9896_NAMETABLE                                                                          \
    static tfaBfName_t Tfa9896DatasheetNames[] = {                                                 \
            ...
            {0xa04, "DCTRIP"}, /* Adaptive boost trip levels (effective only when boost_intel is   \
                                  set to 1), */                                                    \
            {0xa54, "DCHOLD"}, /* Hold time for DCDC booster (effective only when boost_intel is   \
                                  set to 1), */                                                    \
...
#define TFA9896_BITNAMETABLE                                                                       \
    static tfaBfName_t Tfa9896BitNames[] = {                                                       \
            ...
            {0x5d0, "reset_min_vbat"}, /* Battery supply safeguard clipper reset ( if CF_DSP is    \
                                          bypassed), */                                            \
            ...
            {0xa04, "boost_trip_lvl"},   /* Adaptive boost trip levels (effective only when        \
                                            boost_intel is set to 1), */                           \
            {0xa54, "boost_hold_time"},  /* Hold time for DCDC booster (effective only when        \
                                            boost_intel is set to 1), */                           \
            {0xaa1, "bst_slpcmplvl"}, /* Slope compensation current, represents LxF (inductance x  \
                                         frequency) value , */                                     \
            {0xb07,                                                                                \
            ...
            {0xc25, "vi_frac_delay"},   /* Fractional delay adjustment between current and voltage \
                                           sense, */                                               \
            {0xc80,                                                                                \
             "sel_voltsense_out"}, /* TDM output data selection for AEC                 , */       \
            {0xc90,                                                                                \
             "vsense_bypass_avg"},    /* Voltage sense average block bypass                , */    \
            {0xd05, "cf_frac_delay"}, /* Fractional delay adjustment between current and voltage   \
                                         sense by firmware, */                                     \
            {0xe00, "bypass_dcdc_curr_prot"}, /* Control to switch off dcdc current reduction with \
                                                 bat protection, */                                \
            ...
            {0xf11, "dcdc_ctrl_maxzercnt"}, /* DCDC number of zero current flags required to go to \
                                               pfm mode, */                                        \
            {0xf36, "dcdc_vbat_delta_detect"}, /* DCDC threshold required on a delta Vbat (in PFM  \
                                                  mode) switching to PWM mode, */                  \
            ...
            {0x3010, "flag_voutcomp93"}, /* Status flag_voutcomp93, indication Vset is larger      \
                                            than 1.07 x Vbat, */                                   \
            {0x3020, "flag_voutcomp86"}, /* Status flag voutcomp86, indication Vset is larger      \
                                            than 1.14 x Vbat, */                                   \
            {0x3030, "flag_hiz"},      /* Status flag_hiz, indication Vbst is larger than Vbat, */ \
            {0x3040, "flag_ocpokbst"}, /* Status flag_ocpokbst, indication no over current in      \
                                          boost converter PMOS switch, */                          \
            {0x3050, "flag_peakcur"},  /* Status flag_peakcur, indication current is max in dcdc   \
                                          converter, */                                            \
            {0x3060, "flag_ocpokap"},  /* Status flag_ocpokap, indication no over current in       \
                                          amplifier A PMOS output stage, */                        \
            {0x3070, "flag_ocpokan"},  /* Status flag_ocpokan, indication no over current in       \
                                          amplifier A NMOS output stage, */                        \
            {0x3080, "flag_ocpokbp"},  /* Status flag_ocpokbp, indication no over current in       \
                                          amplifier B PMOS output stage, */                        \
            {0x3090, "flag_ocpokbn"},  /* Status flag_ocpokbn, indication no over current in       \
                                          amplifier B NMOS output stage, */                        \
            {0x30a0,                                                                               \
             "flag_adc10_ready"},        /* Status flag_adc10_ready, indication adc10 is ready, */ \
            {0x30b0, "flag_clipa_high"}, /* Status flag_clipa_high, indication pmos amplifier A is \
                                            clipping, */                                           \
            {0x30c0, "flag_clipa_low"},  /* Status flag_clipa_low, indication nmos amplifier A is  \
                                            clipping, */                                           \
            {0x30d0, "flag_clipb_high"}, /* Status flag_clipb_high, indication pmos amplifier B is \
                                            clipping, */                                           \
            {0x30e0, "flag_clipb_low"},  /* Status flag_clipb_low, indication nmos amplifier B is  \
                                            clipping, */                                           \
            {0x310f,                                                                               \
            ...
            {0x3309, "data_adc10_tempbat"},  /* ADC10 data output for testing battery voltage and  \
                                                temperature, */                                    \
            {0x400f, "hid_code"},      /* 5A6Bh, 23147d to access hidden registers (default for    \
                                          engineering), */                                         \
            ...
            {0x4306, "drivebst"},     /* Drive bits to select the power transistor sections boost  \
                                         converter, */                                             \
            {0x4370, "boost_alg"},    /* Control for boost adaptive loop gain              , */    \
            {0x4381, "boost_loopgain"}, /* DCDC boost loopgain setting                       , */  \
            {0x43a0, "ocptestbst"}, /* Boost OCP. For old ocp (ctrl_reversebst is 0); For new ocp  \
                                       (ctrl_reversebst is 1), */                                  \
            {0x43d0,                                                                               \
            ...
            {0x4410, "sensetest"}, /* Test option for the sense NMOS in booster for current mode   \
                                      control., */                                                 \
            ...
            {0x4840, "coincidencebst"}, /* Switch protection on to prevent simultaneously          \
            ...
            {0x49f0, "setse"}, /* Switches between Single Ended and differential mode; 1 is single \
                                  ended, */                                                        \
            ...
            {0x4bd0, "adc13_resonator_enable"}, /* MICADC give extra SNR with less stability       \
                                                   (debug use only), */                            \
            ...
            {0x50c1, "sourcebst"},      /* Sets the source of the pwmbst output to boost converter \
                                           input for testing, */                                   \
            ...
            {0x5306, "digimuxa_sel"},  /* DigimuxA input selection control (see Digimux list for   \
                                          details), */                                             \
            {0x5376, "digimuxb_sel"},  /* DigimuxB input selection control (see Digimux list for   \
                                          details), */                                             \
            {0x5400, "hs_mode"},       /* I2C high speed mode selection control             , */   \
            {0x5412,                                                                               \
             "test_parametric_io"},   /* Control for parametric tests of IO cells          , */    \
            {0x5440, "enbl_ringo"},   /* Enable ring oscillator control, for test purpose to check \
                                         with ringo, */                                            \
            {0x5456, "digimuxc_sel"}, /* DigimuxC input selection control (see Digimux list for    \
                                         details), */                                              \
            ...
            {0x5600, "use_direct_ctrls"}, /* Use direct controls to overrule several functions for \
                                             testing - I2C direct control mode, */                 \
            ...
            {0x5b02, "tsig_freq_msb"}, /* Select internal sine wave generator, frequency control   \
                                          MSB bits, */                                             \
            ...
            {0x6007, "mtpkey1"},   /* 5Ah, 90d To access KEY1_Protected registers (Default for     \
                                      engineering), */                                             \
            {0x6185, "mtp_ecc_tcin"}, /* MTP ECC TCIN data                                 , */    \
            {0x6203, "mtp_man_address_in"}, /* MTP address from I2C register for read/writing mtp  \
            ...
            {0x62a0, "auto_copy_mtp_to_iic"}, /* Start copying all the data from mtp to I2C mtp    \
                                                 registers, */                                     \
            {0x62b0,                                                                               \
...
#define TFA9896_IRQ_NAMETABLE                                                                  \
    static tfaIrqName_t TFA9896IrqNames[] = {                                                  \
            {0, "VDDS"}, {1, "PLLS"},  {2, "DS"},    {3, "VDS"},    {4, "UVDS"},  {5, "CDS"},  \
            {6, "CLKS"}, {7, "CLIPS"}, {8, "MTPB"},  {9, "CLK"},    {10, "SPKS"}, {11, "ACS"}, \
            {12, "SWS"}, {13, "WDS"},  {14, "AMPS"}, {15, "AREFS"}, {16, "16"},   {17, "17"},  \
            {18, "18"},  {19, "19"},   {20, "20"},   {21, "21"},    {22, "22"},   {23, "23"},  \
            {24, "24"},  {25, "25"},   {26, "26"},   {27, "27"},    {28, "28"},   {29, "29"},  \
            {30, "30"},  {31, "31"},   {32, "ERR"},  {33, "ACK"},   {34, "34"},                \
    };

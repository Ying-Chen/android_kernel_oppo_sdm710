...
enum Tfa98xx_Status_ID {
    ...
    Tfa98xx_I2C_Req_Invalid_Seq = 5,   /* Invalid sequence of commands, in case the DSP expects some
                                          commands in a specific order */
    Tfa98xx_I2C_Req_Invalid_Param = 6, /* Generic error */
    Tfa98xx_I2C_Req_Buffer_Overflow = 7, /* I2C buffer has overflowed: host has sent too many
...
enum Tfa98xx_StereoGainSel { Tfa98xx_StereoGainSel_Left, Tfa98xx_StereoGainSel_Right };
...
enum Tfa98xx_Mute { Tfa98xx_Mute_Off, Tfa98xx_Mute_Digital, Tfa98xx_Mute_Amplifier };
 ...
 */
enum Tfa98xx_Error tfa98xx_select_channel(struct tfa_device* tfa, enum Tfa98xx_Channel channel);
 ...
 */
enum Tfa98xx_Error tfa98xx_dsp_read_speaker_parameters(struct tfa_device* tfa, int length,
 ...
 */
enum Tfa98xx_Error tfa98xx_dsp_read_excursion_model(struct tfa_device* tfa, int length,
                                                    unsigned char* pSpeakerBytes);
 ...
 */
enum Tfa98xx_Error tfa98xx_read_data_v6(struct tfa_device* tfa, unsigned char subaddress,
                                        int num_bytes, unsigned char data[]);

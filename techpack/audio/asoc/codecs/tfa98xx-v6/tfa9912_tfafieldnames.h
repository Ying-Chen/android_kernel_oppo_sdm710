...
typedef enum nxpTfa9912BfEnumList {
    ...
    TFA9912_BF_LPM1HLD = 0x6565, /*!< Low power mode1 detector, ctrl hold time before low audio is
    ...
    TFA9912_BF_DCCV = 0x7071,       /*!< Slope compensation current, represents LxF (inductance x
                                       frequency) value  */
    ...
    TFA9912_BF_DCTRIP = 0x7504,     /*!< Adaptive boost trip levels 1, effective only when
                                       boost_intelligent is set to 1 */
    TFA9912_BF_DCTRIP2 = 0x7554,    /*!< Adaptive boost trip level 2, effective only when
                                       boost_intelligent is set to 1 */
    TFA9912_BF_DCTRIPT = 0x75a4,    /*!< Adaptive boost trip levels, effective only when
                                       boost_intelligent is set to 1 */
...
#define TFA9912_NAMETABLE                                                                          \
    static tfaBfName_t Tfa9912DatasheetNames[] = {                                                 \
            ...
            {0x620, "TAPRSTBYPASS"}, /* Tap decimator reset bypass - Bypass the decimator reset    \
                                        from tapdec, */                                            \
            ...
            {0x6565, "LPM1HLD"},   /* Low power mode1 detector, ctrl hold time before low audio is \
                                      reckoned to be low audio, */                                 \
            ...
            {0x7071, "DCCV"},      /* Slope compensation current, represents LxF (inductance x     \
                                      frequency) value , */                                        \
            ...
            {0x7504, "DCTRIP"},    /* Adaptive boost trip levels 1, effective only when            \
                                      boost_intelligent is set to 1, */                            \
            {0x7554, "DCTRIP2"},   /* Adaptive boost trip level 2, effective only when             \
                                      boost_intelligent is set to 1, */                            \
            {0x75a4, "DCTRIPT"},   /* Adaptive boost trip levels, effective only when              \
                                      boost_intelligent is set to 1, */                            \
...
#define TFA9912_BITNAMETABLE                                                                             \
    static tfaBfName_t Tfa9912BitNames[] = {                                                             \
            ...
            {0x620, "bypass_tapdec_reset"}, /* Tap decimator reset bypass - Bypass the decimator         \
                                               reset from tapdec, */                                     \
            ...
            {0x6505, "lpm1_threshold_lvl"}, /* low power mode1 detector   ctrl threshold for             \
                                               low_audio_lvl , */                                        \
            ...
            {0x6600, "dcdc_pfm20khz_limit"}, /* DCDC in PFM mode pwm mode is activated each 50us         \
                                                to force a pwm pulse, */                                 \
            ...
            {0x6c72, "pwms_clip_lvl"}, /* To set the amount of pwm pulse that may be skipped             \
                                          before clip-flag is triggered. , */                            \
            ...
            {0x7071, "bst_slpcmplvl"}, /* Slope compensation current, represents LxF (inductance x       \
                                          frequency) value , */                                          \
            ...
            {0x7504, "boost_trip_lvl_1st"},   /* Adaptive boost trip levels 1, effective only when       \
                                                 boost_intelligent is set to 1, */                       \
            {0x7554, "boost_trip_lvl_2nd"},   /* Adaptive boost trip level 2, effective only when        \
                                                 boost_intelligent is set to 1, */                       \
            {0x75a4, "boost_trip_lvl_track"}, /* Adaptive boost trip levels, effective only when         \
                                                 boost_intelligent is set to 1, */                       \
            {0x7602, "track_decay"}, /* DCDC Boost decay speed after a peak value, effective only        \
                                        when boost_track is set to 1, */                                 \
            {0x7635,                                                                                     \
            ...
            {0x8021, "micadc_speed"}, /* Current sense clock for MiCADC selection - 32/44.1/48 KHz       \
                                         Fs band only, */                                                \
            ...
            {0x8710, "enbl_cs_inn1"}, /* Enable connection of current sense negative1 - I2C direct       \
                                         mode, */                                                        \
            {0x8720, "enbl_cs_inn2"}, /* Enable connection of current sense negative2 - I2C direct       \
                                         mode, */                                                        \
            {0x8730, "enbl_cs_inp1"}, /* Enable connection of current sense positive1      , */          \
            {0x8740, "enbl_cs_inp2"}, /* Enable connection of current sense positive2 - I2C direct       \
                                         mode, */                                                        \
            {0x8750, "enbl_cs_ldo"},  /* Enable current sense LDO - I2C direct mode        , */          \
            {0x8760,                                                                                     \
             "enbl_cs_nofloating_n"}, /* Connect current sense negative to gnda at transitions of        \
                                         booster or classd amplifiers. Otherwise floating (0), */        \
            {0x8770,                                                                                     \
             "enbl_cs_nofloating_p"}, /* Connect current sense positive to gnda at transitions of        \
                                         booster or classd amplifiers. Otherwise floating (0), */        \
            ...
            {0x8930, "cursense_comp_sign"}, /* To change polarity of compensation for current            \
                                               sense compensation, */                                    \
            {0x8940,                                                                                     \
            ...
            {0xc038, "enbl_ref"}, /* Switch on the analog references, each part of the references        \
                                     can be switched on/off individually -  - I2C direct mode, */        \
            {0xc0d0, "enbl_ringo"}, /* Enable the ring oscillator for test purpose       , */            \
            {0xc0e0, "use_direct_clk_ctrl"}, /* Direct clock control to overrule several functions       \
                                                for testing, */                                          \
            {0xc0f0, "use_direct_pll_ctrl"}, /* Direct PLL control to overrule several functions         \
                                                for testing, */                                          \
            {0xc100, "enbl_tsense"},   /* Temperature sensor enable control - I2C direct mode, */        \
            {0xc110, "tsense_hibias"}, /* Bit to set the biasing in temp sensor to high  - I2C           \
                                          direct mode, */                                                \
            ...
            {0xc140, "tap_comp_switch_enable"},     /* Tap Comparator Switch enable control - I2C        \
                                                       direct mode, */                                   \
            {0xc150, "tap_comp_switch_aux_enable"}, /* Tap Comparator Switch enable control - I2C        \
                                                       direct mode, */                                   \
            ...
            {0xc374, "pulselength"},  /* Pulse length setting test input for amplifier (clock d -        \
                                         k*2048*fs), */                                                  \
            {0xc3c0, "tdm_enable_loopback"}, /* TDM loopback test , */                                                                                                    \
            {0xc3d0,                                                                                     \
             "test_abistfft_enbl"},      /* FFT Coolflux                                      , */       \
            {0xc3e0, "test_pwr_switch"}, /* Test mode for digital power switches  core sw/mem            \
                                            sw/micvdd sw, */                                             \
            ...
            {0xc660, "enbl_powerswitch"}, /* Vddd core power switch control - overrules the              \
                                             manager control, */                                         \
            {0xc707, "digimuxa_sel"},     /* DigimuxA input selection control routed to DIO4 (see        \
                                             Digimux list for details), */                               \
            {0xc787, "digimuxb_sel"},     /* DigimuxB input selection control routed to DIO3 (see        \
                                             Digimux list for details), */                               \
            {0xc807, "digimuxc_sel"},     /* DigimuxC input selection control routed to TDO (see         \
                                             Digimux list for details), */                               \
            {0xc901, "dio1_ehs"}, /* Speed/load setting for DIO1 IO cell, clk or data mode range         \
                                     (see SLIMMF IO cell datasheet), */                                  \
            {0xc921, "dio2_ehs"}, /* Speed/load setting for DIO2 IO cell, clk or data mode range         \
                                     (see SLIMMF IO cell datasheet), */                                  \
            {0xc941, "dio3_ehs"}, /* Speed/load setting for DIO3 cell, clk or data mode range (see       \
                                     SLIMMF IO cell datasheet), */                                       \
            {0xc961, "dio4_ehs"}, /* Speed/load setting for DIO4 IO cell, clk or data mode range         \
                                     (see SLIMMF IO cell datasheet), */                                  \
            {0xc981, "spdmo_ehs"}, /* Speed/load setting for PDMO IO cell, clk or data mode range        \
                                      (see SLIMMF IO cell datasheet), */                                 \
            {0xc9a1, "tdo_ehs"},   /* Speed/load setting for TDM IO cell, clk or data mode range         \
                                      (see SLIMMF IO cell datasheet), */                                 \
            {0xc9c0, "int_ehs"},   /* Slew Rate INT IO cell, clk or data mode range (see IIC3V3 IO       \
                                      cell datasheet), */                                                \
            {0xc9d0, "pdmclk_ehs"}, /* Slew RateBCK2/PDMCLK IO cell, clk or data mode range (see         \
                                       IIC3V3 IO cell datasheet), */                                     \
            {0xc9e0, "fs2_ehs"}, /* Slew Rate DS2 IO cell, clk or data mode range (see IIC3V3 IO         \
                                    cell datasheet), */                                                  \
            ...
            {0xcc05, "pll_seli_lbw"},    /* PLL SELI - Low B/W PLL control mode or I2C direct PLL        \
                                            control mode only, */                                        \
            {0xcc64, "pll_selp_lbw"},    /* PLL SELP - Low B/W PLL control mode or I2C direct PLL        \
                                            control mode only, */                                        \
            {0xccb3, "pll_selr_lbw"},    /* PLL SELR - Low B/W PLL control mode or I2C direct PLL        \
                                            control mode only, */                                        \
            {0xccf0, "sel_user_pll_bw"}, /* PLL Low Bandwidth Mode control                    , */       \
            {0xcdf0, "pll_frm"},  /* PLL free running mode control; 1 in TCB direct control mode,        \
                                     else this control bit, */                                           \
            ...
            {0xd202, "tsig_freq_msb"}, /* Select internal sinus test generator, frequency control        \
                                          msb bits, */                                                   \
            ...
            {0xd621, "clkdiv_audio_sel"}, /* Audio clock divider selection in direct clock control       \
                                             mode, */                                                    \
            {0xd641, "clkdiv_muxa_sel"},  /* DCDC MUXA clock divider selection in direct clock           \
                                             control mode, */                                            \
            {0xd661, "clkdiv_muxb_sel"},  /* DCDC MUXB clock divider selection in direct clock           \
                                             control mode, */                                            \
            ...
            {0xd700, "ads1_ehs"}, /* Slew Rate ADS1 IO cell, clk or data mode range (see IIC3V3 IO       \
                                     cell datasheet), */                                                 \
            {0xd710, "ads2_ehs"}, /* Slew Rate ADS2 IO cell, clk or data mode range (see IIC3V3 IO       \
                                     cell datasheet), */                                                 \
            {0xd822,                                                                                     \
            ...
            {0xed45, "fro8_auto_trim_val"}, /* Calibration value from Auto Calibration block, to         \
                                               be written into MTP - Read Only, */                       \
            ...
            {0xf1a5, "spare_mtp1_15_10"}, /* Offset for amplifier, HW gain module - left channel         \
                                             (2's complement), */                                        \
            ...
            {0xf930, "mtp_lock_max_dcdc_voltage"}, /* Disable programming of max dcdc boost              \
                                                      voltage     , */                                   \
...
#define TFA9912_IRQ_NAMETABLE                                                         \
    static tfaIrqName_t Tfa9912IrqNames[] = {                                         \
            {0, "STVDDS"},    {1, "STPLLS"},    {2, "STOTDS"},    {3, "STOVDS"},      \
            {4, "STUVDS"},    {5, "STCLKS"},    {6, "STMTPB"},    {7, "STNOCLK"},     \
            {8, "STSPKS"},    {9, "STACS"},     {10, "STSWS"},    {11, "STWDS"},      \
            {12, "STAMPS"},   {13, "STAREFS"},  {14, "STADCCR"},  {15, "STBODNOK"},   \
            {16, "STBSTCU"},  {17, "STBSTHI"},  {18, "STBSTOC"},  {19, "STBSTPKCUR"}, \
            {20, "STBSTVC"},  {21, "STBST86"},  {22, "STBST93"},  {23, "STRCVLD"},    \
            {24, "STOCPL"},   {25, "STOCPR"},   {26, "STMWSRC"},  {27, "STMWCFC"},    \
            {28, "STMWSMU"},  {29, "STCFMER"},  {30, "STCFMAC"},  {31, "STCLKOOR"},   \
            {32, "STTDMER"},  {33, "STCLPL"},   {34, "STCLPR"},   {35, "STOCPM"},     \
            {36, "36"},       {37, "STLP1"},    {38, "STLA"},     {39, "STVDDP"},     \
            {40, "STTAPDET"}, {41, "STAUDMOD"}, {42, "STSAMMOD"}, {43, "STTAPMOD"},   \
            {44, "STTAPTRG"},                                                         \
    };

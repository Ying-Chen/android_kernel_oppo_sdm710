...
typedef enum nxpTfa9894BfEnumList {
    ...
    TFA9894_BF_LVLCLPPWM = 0x6152,  /*!< Set the amount of pwm pulse that may be skipped before
    ...
    TFA9894_BF_DCCV = 0x7101,       /*!< Slope compensation current, represents LxF (inductance x
                                       frequency) value  */
    ...
    TFA9894_BF_DCTRACK = 0x7160,    /*!< Boost algorithm selection, effective only when
    ...
    TFA9894_BF_DCTRIPT = 0x72a4,     /*!< Track adaptive boost trip levels, effective only when
                                        boost_intelligent is set to 1 */
    TFA9894_BF_DCTRIPHYSTE = 0x72f0, /*!< Enable hysteresis on booster trip levels           */
    TFA9894_BF_DCHOLD = 0x7304,      /*!< Hold time for DCDC booster, effective only when
                                        boost_intelligent is set to 1 */
...
#define TFA9894_BITNAMETABLE                                                                           \
    static tfaBfName_t Tfa9894BitNames[] = {                                                           \
            ...
            {0xcaf0, "pll_frm"},  /* PLL free running mode control; 1 in TCB direct control mode,      \
            ...
            {0xd201, "clkdiv_audio_sel"}, /* Audio clock divider selection in direct clock control     \
                                             mode, */                                                  \
            {0xd221, "clkdiv_muxa_sel"},  /* DCDC MUXA clock divider selection in direct clock         \
                                             control mode, */                                          \
            {0xd241, "clkdiv_muxb_sel"},  /* DCDC MUXB clock divider selection in direct clock         \
                                             control mode, */                                          \
